...
if __name__ == "__main__":
    ...
    parser.add_argument("--src-bpe-tokenizer", type=str, default=None)
    ...
    parser.add_argument("--bpe-tokenizer", type=str, default=None)
    ...
    if args.src_bpe_tokenizer is not None:
        config["src_bpe_tokenizer"] = {
            "bpe": "sentencepiece",
            "sentencepiece_model": args.src_bpe_tokenizer,
        }
    ...
    if args.bpe_tokenizer is not None:
        config["bpe_tokenizer"] = {
            "bpe": "sentencepiece",
            "sentencepiece_model": args.bpe_tokenizer,
        }
