...
class MUSTC(Dataset):
    ...
    def __init__(self, root: str, lang: str, split: str) -> None:
        ...
        # Gather info
        self.data = []
        for wav_filename, _seg_group in tqdm(groupby(segments, lambda x: x["wav"]), desc="group"):
...
def process(args):
    ...
    for lang in args.langs:
        ...
        datasets = {split: MUSTC(root.as_posix(), lang, split) for split in MUSTC.SPLITS}
        if not args.manifest_only:
            ...
            for split in MUSTC.SPLITS:
                ...
                if args.use_audio_input:
                    ...
                    for waveform, sample_rate, _, _, _, utt_id in tqdm(dataset, desc="wav"):
        ...
        if args.use_audio_input:
            gen_config_yaml(
                ...
                extra={
                    ...
                    "src_vocab_filename": spm_filename_prefix + ".txt",
                    "src_bpe_tokenizer": {
                        "bpe": "sentencepiece",
                        "sentencepiece_model": (cur_root / (spm_filename_prefix + ".model")).as_posix(),
                    }
                }
            )
        else:
...
def main():
    ...
    parser.add_argument(
        "--cmvn-type", default="none",
        choices=["global", "utterance", "none"],
