...
if __name__ == "__main__":
    ...
    parser.add_argument("--train-file", help="path to trainset tsv. typically train_st.tsv e.g. train_st.tsv")
    ...
    parser.add_argument("--moses-detok", default='none', metavar="LANG",
                        help="additionally detokenize the distillation data. pass the lang as arg if needed.")
    ...
    md = None
    if args.moses_detok != 'none':
        md = MosesDetokenizer(lang=args.moses_detok)
